...
| 11 | Construction Phase | `4c178529-2592-4964-8c4e-c24240f7e11a` | `registry/construction_phase_registry.json` | ✅ 8행 |
| 12 | Architectural Profile | `543d517e-0025-41f9-8247-b36529734937` | `registry/architectural_profile_registry.json` | ✅ 10행 |
| 13 | 3D Data Completeness Matrix | `98b7b023-0875-4f66-bc57-ad5f3b0d4c7a` | `registry/data_completeness_matrix.json` | ✅ 20행 |
...
| 16 | Relief, Ornament & Iconography | `b21fe70d-5ab2-42e4-92ec-21c87070ff9a` | `registry/relief_ornament_registry.json` | ✅ 8행 |
...
모든 이관은 **2026-08-25** 기준 fresh-read 다. **16/16 완료 · 540행.** SQL 쿼터는 소진됐으나 **view mode 는 쿼터가 없어 우회 가능**하다.
